package org.jbpm.services.task.assigning;
...
public class BaseTaskAssigningTest {
    ...
    protected SolverFactory<TaskAssigningSolution> createSolverFactory() {
        ...
        config.setScoreDirectorFactoryConfig(new ScoreDirectorFactoryConfig().withScoreDrls("org/jbpm/services/task/assigning/solver/taskAssigningScoreRules.drl"));
